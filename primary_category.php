...
include( PRIMARY_CATEGORY_PLUGIN_DIR . 'inc/class-primary-category-widget.php' ); // class to build a category widget that shows only primary categories. Based on the core categories widget.
